                        ...
                        <v-card-text>
                            <v-row v-for="(follow, i) in follows" :key="i">
                                ...
                                <v-col cols="6" align="center" class="fill-height my-auto">
                                    <span class="font-weight-bold pointer" @click="followRedirection(follow.followed._id)">{{
                    ...
                    <v-card :title="dialogTitle" :subtitle="dialogSubtitle">
                        <v-card-text>
                            <v-row v-for="(follow, i) in follows" :key="i">
                                ...
                                <v-col cols="6" align="center" class="fill-height my-auto">
                                    <span class="font-weight-bold pointer" @click="followRedirection(follow.user._id)">{{
